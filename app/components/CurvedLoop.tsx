...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  return (
    <div
      className="flex w-full h-[50px] -mt-3 items-center self-center justify-center"
    ...
    >
      <svg
        className="select-none w-full overflow-visible block text-2xl
        font-medium tracking-[5px] leading-none"
        viewBox="0 0 1440 50"
      >
        <text
          ref={measureRef}
          xmlSpace="preserve"
          style={{ visibility: "hidden", opacity: 0, pointerEvents: "none", height: 0 }}
        >
          {text}
        </text>
        <defs>
        ...
        {ready && (
          <text xmlSpace="preserve" className={`fill-gray4 flex items-center ${className ?? ""}`}>
