...
export function MainScreen() {
  ...
  return (
    <>
      ...
      max-lg1400:w-[70%] max-lg1400:mb-[5rem] max-lg1080:w-[90%]">
        <div className="flex flex-col z-20 max-lg1400:pt-[2rem]">
          ...
          <h1 className="">
            <SplitText
              text="MOBILE + WEB"
              className="text-6xl font-extrabold font-[family-name:var(--font-montserrat-sans)] text-white max-lg1080:text-5xl"
              delay={100}
              duration={0.6}
              ease="power3.out"
              splitType="chars"
          ...
          <div className="pl-1">
            ...
            className="flex justify-center items-center max-w-fit h-[70px] bg-blue my-8 text-white text-2xl
